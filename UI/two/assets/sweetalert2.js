...
parts of handleKeyDown commented out for dingsda in line 1926
*/
  ...
  return new Promise(function (resolve, reject) {
    ...
    var handleKeyDown = function handleKeyDown(event) {
      ...
      if (e.key === 'Enter' && !e.isComposing) {
        ...
        if (true/*e.target.outerHTML === _this.getInput().outerHTML*/) {
    ...
    if (!innerParams.toast && !globalState.windowOnkeydownOverridden) {
      ...
      window.onkeydown = handleKeyDown; // commented out for dingsda
    }
